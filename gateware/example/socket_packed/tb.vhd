...
-- captured trace still reads back as consecutive counter values. Binds a
-- distinct UDP port so it can run alongside the plain socket sim. Driven
-- externally by the acrobe host; runs until killed.
entity tb is
end entity;
