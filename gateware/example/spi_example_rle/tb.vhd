...
-- gaps between them fit in a window a raw capture could never hold.
--
--   udp:4245 -- spi_rle_capture ---------------- 26 probes
--   udp:4246 -- axi/framed -- spi_transactor --SPI--> spi_memory + ram
...
architecture sim of tb is
  ...
  -- Capture bridge (udp 4245), RLE storage
